...
{
	public partial class frmPalagdaanSaPagtanggap : Form
	{
		SqlConnection cn;
		SqlDataAdapter da;
		...
		public frmPalagdaanSaPagtanggap(frmFinalResult f)
		{
			InitializeComponent();
		...
		public void LoadReport()
		{
			try
			{
				...
				this.reportViewer1.LocalReport.ReportPath = @"C:\AldoReport\ReportPalagdaanSaPagtanggap.rdlc";
