...
{
	public partial class frmPayrollSlip : Form
	{
		SqlConnection cn;
		SqlDataAdapter da;
		...
		frmFinalResult f;
		public frmPayrollSlip(frmFinalResult f)
		{
			InitializeComponent();
		...
		public void LoadReportPaySlip()
		{
			try
			{
				ReportDataSource reportDS;
				//ReportDataSource reportDS1;
				this.reportViewer1.LocalReport.ReportPath = @"C:\AldoReport\ReportPaySlip.rdlc";
				...
				cn.Open();
				da.SelectCommand = new SqlCommand("SELECT * FROM tblPayroll WHERE Date_Covered = '" + f.cbodatecoveredPrint.Text + "' ORDER BY Name", cn);
        ...
        public void LoadReportPaySlipManual()
        {
            try
            {
                ReportDataSource reportDS;
                //ReportDataSource reportDS1;
                this.reportViewer1.LocalReport.ReportPath = @"C:\AldoReport\ReportPaySlipManual.rdlc";
                //this.reportViewer1.LocalReport.ReportPath = @"C:\AldoReport\PalagdaanSub.rdlc";
                this.reportViewer1.LocalReport.DataSources.Clear();
